...
<?php if (!empty($arResult['DELIVERY'])) { ?>
    <div class="form__section cls-order-box cls-order-show-box" data-step=1>
                    ...
                    <div class="form__item">
                        <label class="radio">
                            ...
                            <span class="radio__text">
                                <?=$delivery['NAME']//= CYouWanna::multiTranslate($delivery['NAME'], LANGUAGE_ID) ?> <?= trim($delivery['PRICE_FORMATED']) ?>
                            </span>
                            <? if ($delivery['DESCRIPTION']){?>
                            <span class="radio__note">
                                <?= trim($delivery['DESCRIPTION']) ?>
                            </span>
                            <?}?>
