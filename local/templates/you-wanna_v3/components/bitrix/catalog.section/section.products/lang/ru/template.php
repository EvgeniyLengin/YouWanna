...
$MESS['CT_BCS_TPL_MESS_BTN_IN_BASKET'] = 'В корзине';
...
$MESS['CT_BCS_CATALOG_PRICE_DEFAULT'] = 'Сортировать по цене';
$MESS['CT_BCS_CATALOG_PRICE_ASC'] = 'Цена по возрастанию';
$MESS['CT_BCS_CATALOG_PRICE_DESC'] = 'Цена по убыванию';
$MESS['CT_BCS_CATALOG_ZOOM'] = 'Увеличить фото';
$MESS['CT_BCS_CATALOG_QUICK_VIEW'] = 'Быстрый просмотр';
$MESS['CT_BCS_CATALOG_DISCOUNT'] = 'СКИДКА';
$MESS['CT_BCS_CATALOG_N_PRODUCTS'] = 'товаров';
$MESS['CT_BCS_CATALOG_ALL_PRODUCTS'] = 'Все товары';
$MESS['CT_BCS_CATALOG_SHOW_MORE'] = 'Показать ещё';
$MESS['CT_BCS_CATALOG_SHOW_MORE_2'] = 'из';
$MESS['MADE_IN_ITALY'] = 'MADE IN ITALY';
$MESS['MADE_IN_EUROPE'] = 'MADE IN EUROPE';
$MESS['SECTION_TITLE'] = 'Каталог';
$MESS['CT_BCE_CATALOG_PRODUCT_SIMILAR'] = 'Похожие товары';
$MESS['CT_BCE_CATALOG_PRODUCT_RECOMMENDED'] = 'Рекомендуемые товары';
$MESS['CT_BCS_CATALOG_PRICE_ASC'] = 'Цена по возрастанию';
$MESS['CT_BCS_CATALOG_PRICE_DESC'] = 'Цена по убыванию';
$MESS['CATALOG_ADD'] = 'В корзину';
$MESS["CT_RECOMMENDED_BLOCK_TITLE"] = "Рекомендуем";
$MESS["CT_RV_BLOCK_TITLE"] = "Вы смотрели";
