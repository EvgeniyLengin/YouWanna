...
<a class="yw-trendblock__item" href="<?=$arItem['PROPERTIES']['LINK']['VALUE']?>">
	<div class="yw-trendblock__fototext" style="background-image: url()">
		...
		<div class="text">
			<div class="title"><?=CYouWanna::multiTranslateAlt($arItem['PROPERTIES']['PIC2_TITLE']['VALUE'], $arItem['PROPERTIES']['PIC2_TITLE_EN']['VALUE'], LANGUAGE_ID)?></div>
			<div class="desc"><?=CYouWanna::multiTranslateAlt($arItem['PROPERTIES']['PIC2_DESC']['~VALUE']['TEXT'], $arItem['PROPERTIES']['PIC2_DESC_EN']['~VALUE']['TEXT'], LANGUAGE_ID)?></div>
		</div>
	</div>
</a>
