                        ...
                        <tr class="main-row-tr">
                            <td class="w30">
                                <a href="#box-<?= $order['ORDER']['ACCOUNT_NUMBER'] ?>"
                                               class="collapse-toggle <?= $key == '0' ? 'active' : '' ?>"><?= $order['ORDER']['ACCOUNT_NUMBER'] ?></a></td>
                            <td class="w40"><a href="#box-<?= $order['ORDER']['ACCOUNT_NUMBER'] ?>"
                                               class="collapse-toggle <?= $key == '0' ? 'active' : '' ?>"><?= $order['ORDER']['FORMATED_PRICE'] ?></a></td>
                            <td class="w30"><a href="#box-<?= $order['ORDER']['ACCOUNT_NUMBER'] ?>"
                                               class="collapse-toggle <?= $key == '0' ? 'active' : '' ?>"><?= $orderStatus?></a></td>
                        </tr>
                        <tr class="collapse-box <?= $key == '0' ? 'open' : 'hide' ?> hidden-row" id="box-<?= $order['ORDER']['ACCOUNT_NUMBER'] ?>">
                            <td colspan="3" class="inner-row-tr">
                                <table class="payment-info">
                                    ...
                                    <tr>
                                        <td class="w60">
                                            <?= Loc::getMessage('DETAIL_PAYMENT_NAME') ?>
                                        </td>
                                        <td>
                                            <?= $paymentName?>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <?= Loc::getMessage('DETAIL_PAYMENT_STATUS') ?>
                                        </td>
                                        <td>
                                            <?= $paymentStatus?>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <?= Loc::getMessage('DETAIL_PAYMENT_SUM') ?>
                                        </td>
                                        <td>
                                ...
                                <table class="delivery-info" style="width: 50%">
                                    <thead>
                                    <tr>
                                        <td colspan="2">
                                            <?= Loc::getMessage('DETAIL_DELIVERY_HEAD') ?>
                                        </td>
                                    </tr>
                                    </thead>
                                    <tr>
                                        <td class="w60">
                                            <?= Loc::getMessage('DETAIL_DELIVERY_SUM') ?>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <?= Loc::getMessage('DETAIL_DELIVERY_STATUS') ?>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <?= Loc::getMessage('DETAIL_DELIVERY_NAME') ?>
                                        </td>
                                        <td>
                                ...
                                <a class="button secondary upper"
