...
<? if ($arResult["isFormNote"] != "Y") {
    ...
    if ($arResult["isFormDescription"] == "Y" || $arResult["isFormTitle"] == "Y" || $arResult["isFormImage"] == "Y") {
        ...
        if ($arResult["isFormTitle"]) {
            ?>
            <h3><?= GetMessage("VACANCY") ?><?= $_REQUEST['vacancy_name']?></h3>
            <?
        } //endif ;
            ...
            echo $arQuestion["HTML_CODE"];
                ...
                <div class="form-item">
                    <div class="file-block row">
                        <button class="col col-6 button secondary upper outline" id="browse"><?= GetMessage("SELECT_FILE") ?></button>
                        <div class="col col-6 file-name"><?= GetMessage("FILE_NOT_SELECTED") ?></div>
...
<div class="form-item">
                    <textarea
                           ...
                           value="<?= $arQuestion['VALUE']?>"
                           size="0"
                           placeholder="<?= $arQuestion['CAPTION']?>"><?= trim($arQuestion['VALUE'])?></textarea>
</div>
                <?} else {?>
                    <div class="form-item">
                    <input type="<?= $arQuestion['STRUCTURE'][0]['FIELD_TYPE']?>"
