...
if ($USER->IsAuthorized()) {
    ...
    $arUser = $rsUser->Fetch();
    $inpValue['EMAIL'] = $arUser['EMAIL'];
}
?>
<div class="bx-subscribe subscribe-form push-center"  id="sender-subscribe">
<?
...
<!--
<div class="subscribe-form push-center">
    <form action="#" name="subscribe">
        <div class="subscribe-input">
            <input type="text" placeholder="<?/*= Loc::getMessage('FT_YOU_EMAIL') */?>">
        </div>
	...
	<form id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>">
        ...
        <div class="bx_subscribe_submit_container subscribe-submit">
            <input class="sender-btn btn-subscribe" id="bx_subscribe_btn_<?=$buttonId?>" type="submit" value="">
        </div>
	</form>
</div>
