				...
				<div class="basket-items-list-item-descriptions-inner" id="basket-item-height-aligner-{{ID}}">
					...
					<div class="basket-item-block-info">
						...
						<div class="basket-item-block-properties">
	                        ...
	                        <div class="basket-item-info-article"><?= Loc::getMessage('SBB_ARTICLE_ITEM') ?>: {{ARTICLE}}</div>
							{{#NOT_AVAILABLE}}
									...
									switch (trim((string)$blockName))
									{
										...
										case 'sku':
											...
											{{#SKU_BLOCK_LIST}}
												...
												{{#IS_COLOR}}
													<div class="basket-item-property basket-item-property-scu-text basket-item-property--color"
														data-entity="basket-item-sku-block">
														<div class="basket-item-property-name">{{NAME}}</div>
														<div class="basket-item-property-value">                                                            
															<ul class="basket-item-scu-list">
																{{#SKU_VALUES_LIST}}
																	<li class="basket-item-scu-item{{#SELECTED}} selected{{/SELECTED}}
																		...
																		data-hex="{{HEX}}"
																		title="{{NAME}}">
																		<span class="basket-item-scu-item-val" style="background-color: {{HEX}};"></span>
																	</li>
																{{/SKU_VALUES_LIST}}
															</ul>
														</div>
												...
												{{^IS_COLOR}}
													<div class="basket-item-property basket-item-property-scu-text"
														...
														<div class="basket-item-property-name">{{NAME}}</div>
														<div class="basket-item-property-value">
                                                            <div class="basket-property-value-select"><span>{{SELECTED_VALUE}}</span></div>
															<ul class="basket-item-scu-list">
																{{#SKU_VALUES_LIST}}
																	<li class="basket-item-scu-item{{#SELECTED}} selected{{/SELECTED}}
																		{{#NOT_AVAILABLE_OFFER}} not-available{{/NOT_AVAILABLE_OFFER}}"
                            ...
                            <div class="basket-items-list-item-amount">
                                <div class="basket-item-block-amount{{#NOT_AVAILABLE}} disabled{{/NOT_AVAILABLE}}"
                                    ...
                                    <span class="basket-item-amount-field-description">
                                        ...
                                        ?>
                                        <?= Loc::getMessage('SBB_BASKET_QUANTITY') ?>
                                    </span>
                            ...
                            if ($usePriceInAdditionalColumn) {
                                ?>
                                <div
                                    class="basket-items-list-item-price basket-items-list-item-price-for-one<?= (!isset($mobileColumns['PRICE']) ? ' hidden-xs' : '') ?>">
                            ...
                            if ($useSumColumn) {
                                ?>
                                <div
                                    class="basket-items-list-item-price<?= (!isset($mobileColumns['SUM']) ? ' hidden-xs' : '') ?>">
                                    <div class="basket-item-block-price">                                   

                                        <div class="basket-item-price-current">
                                            <span class="basket-item-price-title">
                                                <?= Loc::getMessage('SBB_BASKET_ITEM_PRICE_FOR_TOTAL') ?>
                                            </span>
                        ...
                        <div class="basket-item-block-properties-block-right">
                            <div class="basket-item-actions">
                            <? if (isset($mobileColumns['DELAY'])) {
	                            ?>
	                            <span class="basket-item-actions-delay visible-xs" data-entity="basket-item-add-delayed">
	                                <?= Loc::getMessage('SBB_DELAYED_ADD_ITEM') ?>
	                            </span>
	                            <?
	                        } ?>
