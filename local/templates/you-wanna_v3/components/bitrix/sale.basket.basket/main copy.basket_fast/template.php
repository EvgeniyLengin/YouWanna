...
<script>
    ...
    BX.Sale.BasketComponent.params = BX.Sale.BasketComponent || {};
        if (!BX.Sale.BasketComponent.params.ACTION_VARIABLE) {
            BX.Sale.BasketComponent.params.ACTION_VARIABLE = 'action';
        }
