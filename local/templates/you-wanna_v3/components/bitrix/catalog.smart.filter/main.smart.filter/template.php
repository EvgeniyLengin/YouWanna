...
<div
    ...
    <div class="bx-filter-section">
        <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>"
            ...
            <? endforeach; ?>
            <div class="flex-container flex-row flex-main-block">
                <? foreach ($arResult["ITEMS"] as $key => $arItem)//prices
                {
                    ...
                    if (isset($arItem["PRICE"])):
                        ...
                        ?>
                        <div class="<? if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-4<?
                        else:?>col-12<?endif ?> bx-filter-parameters-box bx-active">
                            ...
                            <div class="bx-filter-block" data-role="bx_filter_block">
                                <div class="row bx-filter-parameters-box-container">
                                    ...
                                    <div class="col-10 bx-ui-slider-track-container">
                ...
                foreach ($arResult["ITEMS"] as $key => $arItem) {
                    ...
                    if (
                        ...
                        continue;
                    ?>
                    <div class="bx-filter-parameters-box flex-container flex-row flex-item
                    <? if ($arItem["DISPLAY_EXPANDED"] == "Y"):?>bx-active<?endif ?>">
                        <? if ($arItem['CODE'] === 'MINIMUM_PRICE') { ?>
                            ...
                            <div class="filter-select-box bx-filter-title-mobile">
                                <span class="filter-select-text">
                                    <span class="bx-filter-title-mobile">
                                        Цена
                                    </span>
                                </span>
                        ...
                        <div class="bx-filter-block<?= $arItem['DISPLAY_TYPE'] === 'A' ? ' slider-block' : '' ?>"
                             data-role="bx_filter_block">
                            <div class="flex-container flex-row bx-filter-parameters-box-container">
                                <?
                                        ...
                                        <div class="radio">
                                            <label class="bx-filter-param-label"
                                                ...
                                                <span class="bx-filter-input-checkbox">
                                                    ...
                                                    />
                                                    <span
                                                        class="bx-filter-param-text"><? echo GetMessage("CT_BCSF_FILTER_ALL"); ?></span>
                                                </span>
                                            </label>
                                        </div>
                                        <? foreach ($arItem["VALUES"] as $val => $ar):?>
                                            <div class="radio">
                                                <label data-role="label_<?= $ar["CONTROL_ID"] ?>"
                                                    ...
                                                    <span
                                                        class="bx-filter-input-checkbox <? echo $ar["DISABLED"] ? 'disabled' : '' ?>">
                                                        <input
                                                            type="radio"
                                                            value="<? echo $ar["HTML_VALUE_ALT"] ?>"
                                ...
                                ?>
                                    ...
                                    <?/* } elseif($arItem['CODE'] === 'SIZE') { ?>
                                        ...
                                        <div class="multiselect-checkbox-block SIZE">
                                            <div class="filter-select-box">
                                                    <span class="filter-select-text">
                                                        <span class="bx-filter-title-mobile">
                                                            <?= $arItem['NAME'] ?>
                                                        </span>
                                                        <span class="bx-filter-title-desktop">Выбрать</span>
                                                    </span>
                                                <i data-role="prop_angle" class="fa fa-angle-down"></i>
                                            </div>
                                            <div class="checkbox-block">

                                                <? foreach ($arItem["VALUES"] as $title => $arSizes) { ?>
                                                    <span><?= $title ?></span>

                                                    <? foreach ($arSizes as $sizeKey => $size) { ?>
                                                        <? if ($size["CHECKED"]) {
                                                            $templateData['CHECKED_SIZES'][] = (string)$sizeKey;
                                                        } ?>
                                                        <div class="checkbox">
                                                            <label data-role="label_<?= $size["CONTROL_ID"] ?>"
                                                                   class="bx-filter-param-label <? echo $size["DISABLED"] ? 'disabled' : '' ?>"
                                                                   for="<? echo $size["CONTROL_ID"] ?>">
                                                                <span class="bx-filter-input-checkbox">
                                                                    <input
                                                                            type="checkbox"
                                                                    ...
                                                                    <span class="bx-filter-param-text"
                                                                        ...
                                                                        if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($size["ELEMENT_COUNT"])):
                                                                            ?>&nbsp;(<span
                                                                                data-role="count_<?= $size["CONTROL_ID"] ?>"><? echo $size["ELEMENT_COUNT"]; ?></span>)<?
                                                                        endif; ?></span>
                                                                </span>
                                                            </label>
                                                        </div>
                                    ...
                                    <?*/ } else { ?>
                                        <div class="multiselect-checkbox-block <?=$arItem['CODE']?>">
                                            <div class="filter-select-box">
                                                <span class="filter-select-text">
                                                    <span class="bx-filter-title-mobile">
                                                        <?= $arItem['NAME'] ?>
            ...
            <? if (!empty($arParams['SMART_FILTER_PATH']) && $arParams['SMART_FILTER_PATH'] !== 'clear') { ?>
                <div class="button-bottom-block">
                    <input
                        class="btn btn-link"
                        type="submit"
                        id="del_filter"
