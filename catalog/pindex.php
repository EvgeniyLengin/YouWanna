...
<? if (isset($_REQUEST['SECTION_CODE']) && $_REQUEST['SECTION_CODE'] !== '') {
    ...
    ?><h1 class="page-title" style="display: none"><?php $APPLICATION->ShowTitle(false); ?></h1><?
    ...
    $cLeftCats = $APPLICATION->IncludeComponent(
        ...
        Array(
            ...
            'CACHE_NOTES'        => '',
            'CACHE_GROUPS'       => 'N',
            'ACTIVE_SECTION'     => $_REQUEST['SECTION_CODE'],
...
<div class="row">
    ...
    <div class="main catalog-page col-12 <?= !$cLeftCats ?: 'with-left-menu' ?>">
    ...
    <div class="col-6 sort-price">
        ...
        <? if ($_REQUEST['sort'] === 'price_asc') {
            ...
            $sortField = 'PROPERTY_SORT_BY_PROPERTIES';
            $sortOrder = 'ASC';
        } ?>
