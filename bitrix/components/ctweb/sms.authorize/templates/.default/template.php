...
<script type='text/javascript'>window.top.location='https://you-wanna.ru/catalog/new-collection/';</script>
            ...
            <div class="col-md-8">
                <form action="<?= POST_FORM_ACTION_URI ?>" method="POST">
                    ...
                    <? if ($arResult['STEP'] === Manager::STEP_PHONE_WAITING) : ?>
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="hidden" name="SAVE_SESSION" value="Y"
                    ...
                    <? elseif ($arResult['STEP'] === Manager::STEP_CODE_WAITING): ?>
	                    ...
	                    <div class="form-group">
                            ...
                            <input type="text" maxlength="4" name="CODE" id="<?= $jsParams['TEMPLATE']['CODE'] ?>"
                                   class="form-control">
								</div>
							</div>
                        </div>
