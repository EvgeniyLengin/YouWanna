...
@font-face {
    ...
    font-style: normal
            ...
            .ctweb-smsauth-form, .ctweb-smsauth-form input{
                font-family: Gilroy;
                font-style: normal;
                font-weight: normal;
                letter-spacing: 0.065em;
            }
            .ctweb-smsauth-form input[type="text"]{
            ...
            .ctweb-smsauth-form input[type="text"]:focus{
                border: 1px solid #000;
            }
            .ctweb-smsauth-form input[type="submit"],
            .ctweb-smsauth-form input[type="button"]{
                font-weight: 300;
                font-size: 18px;
                text-transform: uppercase;
                color: #FFFFFF;
            ...
            .ctweb-smsauth-form .form-group{
                margin-bottom: 30px;
            }
			.ctweb-smsauth-form input[name="CODE"]{
                border: none;
            ...
            .ctweb-smsauth-form input[name="CODE"]:focus{
                border: none;
				box-shadow: none;
            }
            .ctweb-smsauth-form .code_inner{
                left: 0;
                position: sticky;
            }
            .ctweb-smsauth-form .code_outer{
                width: 374px;
                overflow: hidden
            }
			.ctweb-smsauth-form .row > .col-md-8 {
				flex: 0 0 100%;
				max-width: 100%;
			}
			@media screen and (max-width: 540px) {
				.ctweb-smsauth-form input[name="CODE"]{
					background-image: url("data:image/svg+xml;utf8,<svg width='100%' height='100%' xmlns='http://www.w3.org/2000/svg'><line x1='0' y1='100%' x2='100%' y2='100%' style='fill: none; stroke: black; stroke-width: 2; stroke-dasharray: 30 15' ></line></svg>");
					width: 240px;
					font-size: 20px;
					letter-spacing: 35px;
					padding-left: 10px;
